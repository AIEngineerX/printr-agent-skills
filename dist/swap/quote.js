...
export async function getPoolState(inputMint, outputMint, probeAmount) {
...
export async function getPoolStateOrThrow(inputMint, outputMint, probeAmount) {
    ...
    if (state === 'unknown') {
        ...
        throw new Error(`getPoolState: unclassified AMM label "${label}" for ${inputMint} -> ${outputMint}. ` +
